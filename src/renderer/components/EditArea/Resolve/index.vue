					...
					<div class="record-detail-content">
						...
						>
							<property
								...
								@call-dialog="showPropertyDialog(item.key)"
							/>
						</div>
						<div class="image-preview">
							<div class="image-content">

<template>
	<div id="file-manage" class="edit-area">
		<v-dialog content-class="wait-dialog" v-model="waitDialog">
			<div class="text-xs-center">
				<v-progress-linear color="green" :indeterminate="true"></v-progress-linear>
			</div>
		</v-dialog>
		<v-dialog content-class="assert-dialog" v-model="enterFileNameDialog">
			<v-card>
		...
		<div class="file-manage-content" v-show="active === 'open'">
			<div class="file-card" @click="enterFileNameDialog = true">
